...
* **api:** api update ([2cf76c6](https://github.com/ComposioHQ/composio-base-py/commit/2cf76c65b5a4f4ee8ede2f5e867bf2866ed45975))
* **api:** api update ([5d566af](https://github.com/ComposioHQ/composio-base-py/commit/5d566afef536d45abdd2dc7c2f8338416edef723))
* **api:** api update ([09d1b06](https://github.com/ComposioHQ/composio-base-py/commit/09d1b0656240f7f77a66395a2a9e9aefe5147bc2))
* **api:** api update ([e9a80ed](https://github.com/ComposioHQ/composio-base-py/commit/e9a80ed895b34961614b50e15561a8a775a1dec4))
* **api:** api update ([e7d5ce8](https://github.com/ComposioHQ/composio-base-py/commit/e7d5ce807ad695b27c8055d0836ac689fad136d3))
* **api:** api update ([123aa37](https://github.com/ComposioHQ/composio-base-py/commit/123aa377aac374e8d92ca76a045929173c6e5de0))
* **api:** api update ([736ac2e](https://github.com/ComposioHQ/composio-base-py/commit/736ac2e668dcd07fc23aff0ee075965f7a183bc8))

## 1.40.0 (2026-05-19)

Full Changelog: [v1.39.0...v1.40.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.39.0...v1.40.0)

### Features

* **api:** api update ([8ae7706](https://github.com/ComposioHQ/composio-base-py/commit/8ae7706ab1673f5a405acd042839084488965afe))
* **api:** api update ([e5753a6](https://github.com/ComposioHQ/composio-base-py/commit/e5753a6d6364e6b554bfc1d3181597e4843a381c))
* **api:** api update ([0ae0b6b](https://github.com/ComposioHQ/composio-base-py/commit/0ae0b6b89bc2063976912eb3dbfd2f83a9179edb))

## 1.39.0 (2026-05-12)

Full Changelog: [v1.38.0...v1.39.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.38.0...v1.39.0)

### Features

* **api:** api update ([f8da878](https://github.com/ComposioHQ/composio-base-py/commit/f8da878c1ccd85bd59d038b8ffd23356c327f234))
...
* **api:** api update ([35da679](https://github.com/ComposioHQ/composio-base-py/commit/35da679d286cc153f074c2d523e45ccac5801a1e))

## 1.36.0 (2026-05-05)

Full Changelog: [v1.35.0...v1.36.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.35.0...v1.36.0)

### Features

* **api:** api update ([2a1b1c4](https://github.com/ComposioHQ/composio-base-py/commit/2a1b1c472de35e19c07a8030f03f47c06bb0f4e1))
* **api:** manual updates ([a179509](https://github.com/ComposioHQ/composio-base-py/commit/a179509535136ab94a38e533d04aaa2bd2c9c6bf))
* **api:** v3.1 ([576348e](https://github.com/ComposioHQ/composio-base-py/commit/576348ee82c2eb7721a6cbc29955e06893754161))


### Chores

* **internal:** reformat pyproject.toml ([db99a07](https://github.com/ComposioHQ/composio-base-py/commit/db99a077160ea2f352b606e2aacbb3183e2ee0f6))

## 1.35.0 (2026-04-30)

Full Changelog: [v1.34.0...v1.35.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.34.0...v1.35.0)

### Features

* **api:** api update ([125f996](https://github.com/ComposioHQ/composio-base-py/commit/125f9963a651c02c430ac955be6d2897eae4edd2))
* **api:** api update ([12a6ab1](https://github.com/ComposioHQ/composio-base-py/commit/12a6ab15cb1157ad8d2735e745f07e4ce2381fc5))
...
* **api:** api update ([280411a](https://github.com/ComposioHQ/composio-base-py/commit/280411a38f5fdd2bec88960a9ca72d2190eabf2f))

## 1.32.0 (2026-04-10)

Full Changelog: [v1.31.0...v1.32.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.31.0...v1.32.0)

### Features

* **api:** api update ([a6b3f72](https://github.com/ComposioHQ/composio-base-py/commit/a6b3f727ef311c027c63b44ab268c4364df2affc))

## 1.31.0 (2026-04-09)

Full Changelog: [v1.30.0...v1.31.0](https://github.com/ComposioHQ/composio-base-py/compare/v1.30.0...v1.31.0)

### Features

* **api:** api update ([47b6a7e](https://github.com/ComposioHQ/composio-base-py/commit/47b6a7ed0628b5a4ffb525ac04e8bf7475b481e3))
...
* **api:** api update ([fd5760f](https://github.com/ComposioHQ/composio-base-py/commit/fd5760fa7c9437715ac23d8007bd013daae90b75))
* **api:** api update ([6614df8](https://github.com/ComposioHQ/composio-base-py/commit/6614df816229e4925fcb6a4ca0ebb10699ab34d9))
...
* **api:** api update ([1be034c](https://github.com/ComposioHQ/composio-base-py/commit/1be034cca200459e4a11897a93986432cafbea9b))
* **api:** api update ([f74eba9](https://github.com/ComposioHQ/composio-base-py/commit/f74eba91074bb372f1ed0ccd0d78918f9cbe9914))
* **api:** api update ([cdc9410](https://github.com/ComposioHQ/composio-base-py/commit/cdc9410aee2e8b9b0880cea90f0742530ca599f0))
* **api:** api update ([55681a7](https://github.com/ComposioHQ/composio-base-py/commit/55681a7ca1df7fe24e7361279e992b63b5d538d2))
* **api:** manual updates ([637fbfe](https://github.com/ComposioHQ/composio-base-py/commit/637fbfe951fc551005ec314ce316c7838a8f126b))
...
* **api:** api update ([2264354](https://github.com/ComposioHQ/composio-base-py/commit/22643545739c0319467aadbb5bdb8536fcca95ec))
* **api:** manual update ([213128d](https://github.com/ComposioHQ/composio-base-py/commit/213128d48a9c554f9ceb32ebd568d8b8ff921907))
